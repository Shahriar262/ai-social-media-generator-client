...
import { RelatedItems } from "@/components/explore/RelatedItems";
        ...
        <div className="max-w-7xl mx-auto pt-10 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 w-full">
              <div className="group relative w-full flex justify-center items-center rounded-[3rem] overflow-hidden bg-white/[0.04] backdrop-blur-2xl p-4 border border-white/10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] transition-all hover:border-indigo-500/30">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button
                  ...
                  className="p-5 rounded-3xl border border-white/10 bg-white/[0.04] backdrop-blur-2xl hover:bg-white/[0.08] text-white transition-all shadow-lg"
                >
      ...
      <div className="max-w-7xl mx-auto px-6 pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            {/* Workflow Card */}
            <div className="bg-white/[0.04] backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-b from-white/[0.05] to-transparent pointer-events-none" />
              <h2 className="text-2xl font-black text-white mb-8 flex items-center gap-3 relative">
                <Layers className="text-secondary w-6 h-6" /> Operational
                Workflow
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative">
                {tool.workflow.map((step, i) => (
                  <div
                    key={i}
                    className="flex gap-4 p-5 rounded-2xl bg-black/20 border border-white/5 group hover:border-primary/40 transition-all hover:bg-black/40"
                  >
                    ...
                    <p className="text-slate-300 font-bold text-sm leading-tight self-center">
                      {step}
                    </p>
                  </div>
                ))}
            ...
            {/* Review Section */}
            <ReviewSection assetId={tool.id} />

            {/* Features Detail */}
            <div className="bg-white/[0.04] backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-b from-white/[0.05] to-transparent pointer-events-none" />
              <h2 className="text-2xl font-black text-white mb-8 flex items-center gap-3 relative">
                <Shield className="text-emerald-400 w-6 h-6" /> Strategic
                Capabilities
              </h2>
          ...
          <div className="space-y-8">
            <div className="bg-white/[0.04] backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 shadow-2xl relative group overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-b from-white/[0.05] to-transparent pointer-events-none" />
              <h3 className="text-xs font-black text-slate-500 mb-8 uppercase tracking-[0.2em] relative">
                Engine Specs
              </h3>
            ...
            <div className="bg-white/[0.04] backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 shadow-xl relative overflow-hidden bg-gradient-to-br from-white/[0.04] to-primary/5">
              <h3 className="text-lg font-black text-white mb-6 flex items-center gap-2 relative">
                <BarChart3 className="w-5 h-5 text-secondary" /> Neural
                Analytics
              </h3>
              <div className="grid grid-cols-1 gap-4 relative">
                {Object.entries(tool.stats).map(([key, value]) => (
                  <div
                    key={key}
                    className="bg-black/40 p-4 rounded-2xl flex justify-between items-center border border-white/5 hover:border-primary/20 transition-all shadow-inner"
                  >
